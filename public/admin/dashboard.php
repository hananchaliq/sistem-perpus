...
$total_pengurus = $pdo->query("SELECT COUNT(*) FROM pengurus")->fetchColumn();
$total_denda = $pdo->query("SELECT COUNT(*) FROM denda")->fetchColumn();
...
<div id="content">
   ...
   <div class="container-fluid">
      <div class="mb-2">
         <span class="text-primary ">Halo, Selamat datang kembali
            <?= $username; ?> 👋
         </span>
         ...
         <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-info shadow h-100 py-2">
               <div class="card-body">
                  <div class="row no-gutters align-items-center">
                     <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Denda</div>
            ...
            <div class="card shadow mb-4">
               ...
               <div class="card-body">
                  ...
                  <div class="mt-4 text-center small">
                     <span class="mr-2">
                        <i class="fas fa-circle text-primary"></i> Pinjaman
                     </span>
                     <span class="mr-2">
                        <i class="fas fa-circle text-success"></i> Total Buku
                     </span>
                     <span class="mr-2">
                        <i class="fas fa-circle text-info"></i> Denda
                     </span>
                  </div>
               </div>
            </div>
               ...
               <div class="card-body">
                  <div class="text-center">
                     <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                        src="<?= $base ?>img/undraw_posting_photo.svg" alt="...">
                  </div>
